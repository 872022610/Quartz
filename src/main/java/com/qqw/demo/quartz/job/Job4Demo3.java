...
@Component
public class Job4Demo3 extends QuartzJobBean {
    ...
    public void executeInternal(JobExecutionContext jobExecutionContext){
        ...
        System.out.println("job3参数列表" + JsonPluginsUtil.mapToString(jobDataMap));

        DemoTable insertDemoTable = new DemoTable();
        insertDemoTable.setCreateTime(new Date());
        insertDemoTable.setJobClassName("Job4Demo3");
